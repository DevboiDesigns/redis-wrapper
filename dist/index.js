    ...
    this.initRedisClient = () => __async(this, null, function* () {
      if (!this.client) {
        if (IS_LOCAL === "true") {
          ...
          this.client = (0, import_redis.createClient)({ url: REDIS_LOCAL_URL });
        } else {
        ...
        const sessionStore = new import_connect_redis.default({ client: this.client });
        const sessionDetails = (0, import_express_session.default)({
          store: sessionStore,
